...
def main():
    ...
    parser.add_argument('--log_dir', default='best')
    parser.add_argument('--data_paths', default='npzs/bj_dahye, npzs/aihub_kss')
    parser.add_argument('--load_path', default="best/checkpoint")  
    ...
    parser.add_argument('--checkpoint_interval', type=int, default=1201) # 2000
